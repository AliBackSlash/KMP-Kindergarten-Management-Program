        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (counter >= IntroScript.Length)
            {
                IntroScript = "تم تفعيل البرنامج بنجاح! 🎉\n" +
                              ...
                              ":بعد انشاء حسابك قم بالاجراءات الاتية" +
                              "❇️ توجه الي شاشة الاعدادات وقم بضبطا لتناسب استخدامك." +
                              "توجه الي شاشة الفصول ثم المستويات واضف الفصول والمستويات الخاصة بحضانتك❇️." +
                              ". ❇️هنا تستطيع أن تضيف الاطفال من قسم الاطفال سوف تجد التعليمات هناك " +
                              "وكذلك اضافة المدرسين والعمال❇️. " +
