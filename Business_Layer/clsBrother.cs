...
namespace MyBusinessLayer
{
    public class clsBrother
    {
        ...
        public static clsBrother Find(int ID)
        {
            ...
            int ChildID = 0;
            bool Found = clsBrothersData.GetChildBrothers(ID,ref name,ref date,ref ChildID);
        ...
        {
            return clsBrothersData.delete_BrotherswithID(ID);
        }
        public static bool delete_BrotherswithName(string Name)
        {
            return clsBrothersData.delete_BrotherswithName(Name);
        }
