...
namespace MyBusinessLayer
{
    public class clsWorker
    {
        ...
        public clsWorker (string Code,string name, string Phone, string CardNumber, bool Gender, string Image, float Salary, bool Period)
        {
            this.Code = Code;
            this.name = name;
            this.Phone = Phone;
        ...
        public static clsWorker Find(string Code)
        {
        ...
        {
            string Code = "", Phone = "", CardNumber = "", Image = "";
            bool Gender = false, Period = false;
            float Salary = 0;

            bool found = clsWorkerDate.FindByName(Name, ref Code, ref Phone, ref CardNumber, ref Gender, ref Image, ref Salary, ref Period);
