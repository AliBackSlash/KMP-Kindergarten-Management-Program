...
namespace MyBusinessLayer
{
    public class clsEmployee
    {
        ...
        public clsEmployee(string Id,string name, string qulification, string school, string cardNumber,
        ...
        //new
        public static clsEmployee Find(string Code)
        {
        ...
        {
            string Code = "", Qulification = "", School = "", CardNumber = ""
                               , Email = "", Phone = "", Address = "",
                                 Image = "";
            DateTime DateOfBirth = DateTime.Now;
            bool Gendor = false, Period = false;
            ...
            bool found = clsEmployeeData.FindByName(Name, ref Code, ref Qulification, ref School, ref CardNumber
                               , ref Email, ref Phone, ref DateOfBirth, ref Address, ref SocialStatus,
                                 ref Image, ref Gendor, ref Period, ref Salary, ref ClassID, ref LevelID);
        ...
        {
            return clsEmployeeData.AddTeacher(OldID, Name, Qualification, School, CardNumber
                               , Email, Phone, DateOfBirth, Address, SocialStatus, 
                                 Image, Gendor, Period,Salary,  ClassID, LevelID);
        }
        //new
        ...
        {
            return clsEmployeeData.UpdateTeacher( OldID,NewID, Name,  Qualification,  School,  CardNumber
                                                  ,  Email,  Phone,  DateOfBirth,  Address,  SocialStatus,
                                                   Image,  Gendor,  Period,  Salary,  ClassID,  LevelID);
        ...
        {
            return clsEmployeeData.GetNameFromTables(TableName);
        }
        ...
        {
            return clsEmployeeData.DeleteTeatcher(ID);
        }
        public static DataTable GetOneTeacherWithInfo(string Name)
        {
            return clsEmployeeData.GetOneTeacherWithInfo(Name);
        }
