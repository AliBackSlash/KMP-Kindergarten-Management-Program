...
namespace MyBusinessLayer
{
    public class clsChild
    {
        ...
        public clsChild(string code, string name, string city, string address, 
            ...
            string mail, string infoAboutChild, float subscID)
        {
            ...
            personCanTake = clsPersonCanTake.Find(code);
            mode = enMode.Update;
        ...
        {
            return clsChildData.AddNewChaild(this.NewCode, this.name, this.city, this.address, this.dateOfBirth, this.period, this.levelID
        ...
        {
            return clsChildData.UpdateChildInfo(this.OldCode,this.NewCode, this.name, this.city, this.address, this.dateOfBirth, this.period, this.levelID
            , this.classID, this.dateOfJoin, this.bus, this.branch, this.gendor, this.image, this.howYouKnowNurssry, this.socialStatus
            , this.messageNumber, this.mail, this.infoAboutChild, this.SubAmount);
        }

        public static clsChild FindByCode(string Code)
        {
        ...
        {
            return clsChildData.GetKidsPersonalInfoWithName(Name);
        }
        //
        public static DataTable GetKidsPersonalDataWithID(string ID)
        {
            return clsChildData.GetKidsPersonalInfowithID(ID);
        }
        ...
        {
            return clsChildData.GetKidsAllPersonalInfo(Name);
        }

        public static short GetClassID(string Name)
        {
            return clsChildData.GetClassID(Name);
        }

        public static short GetLevelID(string Name)
        {
            return clsChildData.GetLevelID(Name);
        }

        public static string GetClassName(short ID)
        {
            return clsChildData.GetClassName(ID);
        }

        public static string GetLevelName(short ID)
        {
            return clsChildData .GetLevelName(ID);
        }
